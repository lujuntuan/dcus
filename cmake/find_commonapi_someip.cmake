...
begin_3rdparty_search(CommonAPI-SomeIP)
if(CMAKE_HOST_WIN32)
...
function(commonapi_someip_generate_src _out_var _opt_value)
    if(${ARGC} LESS 3)
    ...
    foreach(it ${_file_sources})
        ...
        list(APPEND outfile
            ${outdir}/${_opt_value}SomeIPProxy.hpp
            ${outdir}/${_opt_value}SomeIPProxy.cpp
            ${outdir}/${_opt_value}SomeIPStubAdapter.hpp
            ${outdir}/${_opt_value}SomeIPStubAdapter.cpp
            ${outdir}/${_opt_value}SomeIPDeployment.hpp
            ${outdir}/${_opt_value}SomeIPDeployment.cpp
            )
        add_custom_command(
            OUTPUT ${outfile}
            COMMAND ${CMAKE_COMMAND} -E make_directory ${outdir}
            COMMAND ${COMMONAPI_SOMEIP_GENERATOR_EXE} ${it} --dest=${outdir}
...
endfunction(commonapi_someip_generate_src)
