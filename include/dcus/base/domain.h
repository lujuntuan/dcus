...
struct DCUS_EXPORT Domain final {
    ...
    CREATE_PUBLIC_PROPERTY(WorkerState, state, WR_UNKNOWN)
    CREATE_PUBLIC_PROPERTY(WorkerState, last, WR_UNKNOWN)
...
public:
    static std::string getMrStateStr(MasterState state) noexcept;
    static std::string getWrStateStr(WorkerState state) noexcept;
    static std::string getControlStr(Control control) noexcept;
    static std::string getAnswerStr(Answer answer) noexcept;
    static bool mrStateIsBusy(MasterState state) noexcept;
    static bool wrStateIsBusy(WorkerState state) noexcept;
    static bool mrStateIsAsk(MasterState state) noexcept;
