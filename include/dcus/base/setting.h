...
#define DCUS_QUEUE_ID_MASTER 1
#define DCUS_QUEUE_ID_WORKER 2
...
#define DCUS_MAX_DEPLOY_TIME_WORKER 60000 * 60
#define DCUS_MAX_DEPLOY_RESTART_TIME_WORKER 60000 * 1
...
#define DCUS_MASTER_NAME "dcus_server"
